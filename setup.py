...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        if not "<string>" in open(
                os.path.join(setup_path, 'deps', 'dnp3', 'cpp', 'libs',
                             'include', 'asiodnp3',
                             'IMasterOperations.h')).read():
...
setup(
    ...
    version=__version__,
    author='Kyle Wang',
    author_email='kyle@super.com',
    url='https://github.com/kyle8615/ddd',
    description='pydnp3 -- python binding for opendnp3',
    long_description='',
    install_requires=['pybind11>=2.2'],
    ext_modules=[CMakeExtension('ddd')],
